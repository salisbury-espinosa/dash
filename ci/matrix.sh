...
export BUILDER_IMAGE_NAME="dash-builder-$BUILD_TARGET"
...
export DOCKER_RUN_ENV_ARGS="-e SRC_DIR=$SRC_DIR -e CACHE_DIR=$CACHE_DIR -e PULL_REQUEST=$PULL_REQUEST -e BUILD_NUMBER=$BUILD_NUMBER -e BUILD_TARGET=$BUILD_TARGET"
